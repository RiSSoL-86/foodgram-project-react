# Generated by Django 3.2.3 on 2023-12-21 12:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveIntegerField(help_text='Укажите время приготовления, от 1 мин', validators=[django.core.validators.RegexValidator('^[1-9][0-9]*$', 'Поддерживаемые значения.')], verbose_name='Время приготовления')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveIntegerField(help_text='Укажите кол-во ингредиента, от 1 и более', validators=[django.core.validators.RegexValidator('^[1-9][0-9]*$', 'Поддерживаемые значения.')], verbose_name='Кол-во ингредиента')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Укажите аббревиатуру тега', null=True, unique=True, validators=[django.core.validators.RegexValidator('^[-a-zA-Z0-9_]+$', 'Поддерживаемые знаки.')], verbose_name='Аббревиатура тега')),
            ],
            options={
                'verbose_name': 'Тег',
